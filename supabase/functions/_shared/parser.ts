// Transcript parsing + semantic chunking, extracted unchanged from
// transcripts-upload so other functions can reuse it.
 ...
 */
export function parseTranscript(content: string, fileType: string, transcriptId: string): TranscriptSegment[] {
